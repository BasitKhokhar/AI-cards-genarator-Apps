    ...
    <View style={[styles.screen, { backgroundColor: colors.bodybackground }]}>
      ...
      >
        <View style={[styles.formContainer, { backgroundColor: colors.cardsbackground }]}>
          ...
          <Text style={[styles.subtitle, { fontFamily: fonts.subheading }]}>
            Manage and update your Cardify-AI profile
          </Text>

          {/* Name */}
          <View style={styles.inputGroup}>
            <Text style={[styles.label, { fontFamily: fonts.medium }]}>Name</Text>
            <TextInput
              value={name}
              onChangeText={setName}
              placeholder="Name"
          ...
          {/* Email */}
          <View style={styles.inputGroup}>
            <Text style={[styles.label, { fontFamily: fonts.medium }]}>Email</Text>
            <TextInput
              value={email}
              onChangeText={setEmail}
              placeholder="Email"
          ...
          {/* Phone */}
          <View style={styles.inputGroup}>
            <Text style={[styles.label, { fontFamily: fonts.medium }]}>Phone</Text>
            <TextInput
              value={phone}
              onChangeText={setPhone}
              placeholder="Phone"
          ...
          <TouchableOpacity
            ...
            disabled={uploading}
          >
            <Text style={[styles.simpleButtonText, { fontFamily: fonts.medium }]}>
              {uploading ? "Uploading..." : "Upload Profile Image"}
            </Text>
          </TouchableOpacity>
        ...
        {showToast && (
          ...
          >
            ...
            >
              ...
              <Text style={[styles.confirmationTitle, { fontFamily: fonts.heading }]}>Done</Text>
              <Text style={[styles.confirmationText, { fontFamily: fonts.body }]}>
                {toastMessage}
              </Text>
            </MotiView>
          </MotiView>
