...
//                   {userData.name}
//                 </Text>
//                 <Text style={[styles.email, { color: colors.mutedText, fontFamily: fonts.body }]}>
//                   {userData.email}
//                 </Text>
//               </View>
//             </View>
...
//             {/* General Section */}
//             <View style={styles.sectionHeader}>
//               <Text style={[styles.heading, { color: colors.text, fontFamily: fonts.subheading }]}>
//                 General
//               </Text>
//             </View>

//             {[{ name: "person-outline", label: "Personal Info", route: "AccountDetail" },
//               { name: "credit-card", label: "Payment Methods", route: "PaymentmethodsScreen" }].map(
//               (item, idx) => (
//                 <TouchableOpacity
//                   key={idx}
//                   style={[styles.section, { backgroundColor: colors.bodybackground, borderColor: colors.border }]}
...
//                   <View style={styles.leftContent}>
//                     <Icon name={item.name} size={24} color={colors.text} />
//                     <Text style={[styles.sectionText, { color: colors.text, fontFamily: fonts.medium }]}>
//                       {item.label}
//                     </Text>
//                   </View>
//                   <Icon name="chevron-right" size={24} color={colors.text} />
...
//               { name: "headset-mic", label: "Customer Support", route: "CustomerSupport" },
//               { name: "security", label: "Privacy Policy", onPress: () => handleOpenPdf(2) },
//               { name: "help-outline", label: "FAQs", route: "faq" }].map((item, idx) => (
//               <TouchableOpacity
//                 key={idx}
//                 style={[styles.section, { backgroundColor: colors.bodybackground, borderColor: colors.border }]}
//                 onPress={
//                   item.onPress
//                     ? item.onPress
//                     : () => navigation.navigate(item.route, { userData })
//                 }
//               >
//                 <View style={styles.leftContent}>
//                   <Icon name={item.name} size={24} color={colors.text} />
...
//               <View style={styles.leftContent}>
//                 <Icon name="logout" size={24} color={colors.text} />
//                 <Text style={[styles.logoutText, { color: colors.text, fontFamily: fonts.medium }]}>
//                   Logout
//                 </Text>
//               </View>
//               <Icon name="chevron-right" size={24} color={colors.text} />
...
//           </View>
//         ) : (
//           <Text style={[styles.text, { color: colors.mutedText, fontFamily: fonts.body }]}>
//             No user data found.
//           </Text>
//         )}
//       </ScrollView>
...
//                 <Loading />
//               </View>
//               <Text style={[styles.loaderText, { fontFamily: fonts.medium }]}>Please wait...</Text>
//             </MotiView>
//           </MotiView>
//         )}
//       </AnimatePresence>
...
//     borderRadius: 60,
//   },
//   headingsContainer: { flexDirection: "column" },
//   title: { fontSize: 22 },
//   email: { fontSize: 14 },
//   cardButton: {
//     width: "100%",
...
//     shadowRadius: 6,
//   },
//   leftContent: { flexDirection: "row", gap: 12, alignItems: "center" },
        ...
        {loading ? (
          ...
          <View style={styles.profileContainer}>
            ...
            >
              <View style={styles.leftContent}>
                <Icon name="logout" size={24} color={colors.text} />
                <Text style={[styles.logoutText, { color: colors.text, fontFamily: fonts.medium }]}>Logout</Text>
              </View>
              <Icon name="chevron-right" size={24} color={colors.text} />
            </TouchableOpacity>
          </View>
      ...
      <Modal transparent visible={showLogoutModal} animationType="fade">
        <View style={styles.modalOverlay}>
          <View style={[styles.modalContent, { backgroundColor: colors.cardsbackground }]}>
            <Text style={[styles.modalTitle, { color: colors.text }]}>Are you sure you want to logout?</Text>
...
const styles = StyleSheet.create({
  ...
  loaderRing: { marginBottom: 12 },
  loaderText: { fontSize: 15,color:colors.text },
   modalOverlay: { flex: 1, justifyContent: "center", alignItems: "center", backgroundColor: "rgba(0,0,0,0.5)" },
  modalContent: { width: "90%",borderWidth:1,borderColor:colors.border, borderRadius: 16, paddingVertical: 30, paddingHorizontal: 20, alignItems: "center" },
  modalTitle: { fontSize: 20, fontWeight: "bold" },
  modalButton: { flex: 1, paddingVertical: 10, marginHorizontal: 5, borderRadius: 10, alignItems: "center" },
});
