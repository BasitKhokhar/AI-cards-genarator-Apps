...
//               <Text style={{ color: colors.primary, fontSize: 12, fontWeight: '500' }}>{showCustomSize ? "Hide" : "Custom"}</Text>
//             </TouchableOpacity>
//           </View>
...
//   dimText: { fontSize: 13 },
//   customBtn: { backgroundColor: "rgba(6,182,212,0.1)", paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8, marginLeft: 8 },
...
const TemplateDetail = ({ route }) => {
  ...
  useEffect(() => {
    if (showGenerationBar) {
      const timer = setTimeout(() => setShowGenerationBar(false), 7000);
              ...
              return (
                <TouchableOpacity
                  ...
                  style={[
                    ...
                    { borderColor: isSelected ? colors.text : colors.secondary },
                  ]}
                >
                  <MaterialCommunityIcons
                    name={iconName}
                    ...
                    style={{ marginRight: 6 }}
                  />
                  <Text style={[styles.optionText, { color: isSelected ? colors.text : colors.mutedText }]}>
                    {item.label}
                  </Text>
                </TouchableOpacity>
              );
          ...
          <View style={styles.row}>
            {resolutionOptions.map((res) => (
              <TouchableOpacity
                ...
                style={[
                  styles.optionBtn,
                  resolution === res && styles.optionSelected,
                  { borderColor: resolution === res ? colors.text : colors.secondary },
                ]}
              >
                <MaterialCommunityIcons
                  name={res === "4K" ? "television" : res === "2K" ? "monitor" : "image-outline"}
                  ...
                  style={{ marginRight: 6 }}
                />
                <Text style={[styles.optionText, { color: resolution === res ? colors.text : colors.mutedText }]}>
                  {res}
                </Text>
              </TouchableOpacity>
            ))}
